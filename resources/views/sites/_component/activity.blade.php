...
<section class="whiteSection">
    <div class="container">
        ...
        <div class="row isotopeContainer">
            @foreach($categories->services as $activity) 
                <div class="col-sm-4 isotopeSelector asia">
                    <article class="">
                        <figure>
                            ...
                            <div class="overlay">
                                <a class="fancybox-pop" href="{{ route('activity.detail', $activity->id) }}">
                                    <div class="overlayInfo">
                                        <h5><span>{{ $activity->price }}</span></h5>
                                        <p><i class="fa fa-calendar" aria-hidden="true"></i>{{ substr($activity->description, 0, 20) }}...</p>
                                        <p><i class="fa fa-calendar" aria-hidden="true"></i>{{ substr($activity->description, 0, 20) }}...</p>
                                    </div>
                                </a>
                            </div>
