                    ...
                    @else    
                        <li class="dropdown singleDrop active">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li class=""><a id="list_booking" href="#">{{ trans('site.booking') }}</a></li>
                                <li class="">
                                    <a href="{{ route('logout') }}">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav dashboardNavLeft">
                    ...
                    <li><a href="" id="list_booking"><i class="fa fa-cube" aria-hidden="true"></i>{{ trans('site.booking') }}</a></li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">{{ trans('site.list_booking') }}</h4>
            </div>
